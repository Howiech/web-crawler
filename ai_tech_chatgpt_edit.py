...
#"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" --profile-directory="Default" --remote-debugging-port=9223
...
def navigate_and_ask_openai(driver):
    ...
    driver.find_element(By.XPATH, '//*[@id="prompt-textarea"]').send_keys(
        '一分鐘介紹一個真實的科技故事或知識,只有內容,不要加標題,不要其他多餘的介紹或對話')
    button_tech = driver.find_element(By.XPATH, '//*[@id="__next"]/div[1]/div[2]/div/main/div/div[2]/form/div/div[2]/button')
    button_tech.click()
    time.sleep(30)
    try:
        answer_tech = driver.find_element(By.XPATH,
                                          '//*[@id="__next"]/div[1]/div[2]/div/main/div/div[1]/div/div/div/div[2]/div/div[2]/div[1]/div/div').text
        print(answer_tech)
        pc.copy(answer_tech)
    except NoSuchElementException:
        print('再等15秒')
        time.sleep(15)
        answer_tech = driver.find_element(By.XPATH, '//*[@id="__next"]/div[1]/div[2]/div/main/div/div[1]/div/div/div/div[2]/div/div[2]/div[1]/div/div').text
        print(answer_tech)
        pc.copy(answer_tech)
...
def open_fliki_and_create_audio(driver):
    ...
    time.sleep(5)
    driver.find_element(By.XPATH, '/html/body/div[3]/div/form/div[1]/div[3]/input').send_keys('科技新知230817')
    time.sleep(0.5)
...
def download_audio(driver):
    ...
    time.sleep(10)
    pyautogui.click(936, 415)  # export
    time.sleep(3)
...
def aiprm_open():
    ...
    time.sleep(5)
    pyautogui.click(828, 553)  # MJourney
    time.sleep(4)
